...
def custom_load_lvis_json(json_file, image_root, dataset_name=None):
    ...
    for (img_dict, anno_dict_list) in imgs_anns:
        ...
        if 'mask_cat' in img_dict:
            record["mask_cat"] = img_dict["mask_cat"]
...
#         os.path.join("/mnt/data/detectron2_datasets/", json_file) if "://" not in json_file else json_file,
#         os.path.join("/mnt/data/detectron2_datasets/", image_root),
#     )
