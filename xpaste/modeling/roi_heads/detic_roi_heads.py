...
class DeticCascadeROIHeads(CascadeROIHeads):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.xpaste_mask_loss=xpaste_mask_loss
        # TODO
    ...
    def from_config(cls, cfg, input_shape):
        ...
        ret.update({
            ...
            'xpaste_mask_loss': cfg.MODEL.USE_XPASTE_MASK_LOSS
        })
        return ret
        ...
        for proposals_per_image, targets_per_image in zip(proposals, targets):
            ...
            if len(targets_per_image) > 0:
                ...
                if targets_per_image.has('instance_source'):
                    ...
                    instance_source[proposal_labels == 0] = 0
                ...
                if targets_per_image.has('instance_source'):
                    instance_source=torch.zeros_like(matched_idxs)
    ...
    def forward(self, images, features, proposals, targets=None,
        ann_type='box', classifier_info=(None,None,None), sem_seg_gt=None, **kwargs):
        '''
